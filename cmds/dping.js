...
module.exports = {
    name: 'dping',
    aliases: ['dpong'],
    description: "Check the connection ping to Discord's servers delete",
    cooldown: 5,
    async execute(message, args) {
        try {
            ...
            const embed = tools.makeEmbed(':alarm_clock:   Ping statisitics', `'Delete: ${messageDeletePing} `, null, message.channel );
        } catch (err) {
