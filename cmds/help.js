        ...
        try {
            ...
            if (!args.length) {
                ...
                .setDescription(message.client.commands.map(mapFunction).join('\n'))
                 .setFooter('hi i am iylibrarys the storage and moderation bot for the pepe planet dev server :D', 'https://static-cdn.jtvnw.net/jtv_user_pictures/chansub-global-emoticon-1c8ec529616b79e0-21x18.png');
            } else {
