...
module.exports = {
    name: 'wping',
    aliases: ['wpong'],
    description: "Check the connection ping to Discord's servers web",
    cooldown: 5,
    async execute(message, args) {
        try {
            ...
            const embed = tools.makeEmbed(':alarm_clock:   Ping statisitics', `Websocket ping: ${websocketPing} ms\n`, null, message.channel );
        } catch (err) {
